...
html #subscribe-button ytd-button-renderer #button.ytd-button-renderer:active,html #subscribe-button tp-yt-paper-button.ytd-subscribe-button-renderer:active {
    ...
    if (settings.search_left) {
      ...
      yt-notification-action-renderer{margin-left:218px;}
      `);
    }
    if (settings.no_apps) {
        styles.push(`
...
tp-yt-paper-toast.paper-toast-open yt-formatted-string:before {
...
#endpoint[href="/feed/library"] tp-yt-paper-item.ytd-guide-entry-renderer {
    padding: 0 !important
}
`);
}
